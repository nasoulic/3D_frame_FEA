...
agv_frame.add_support(n23.id, [1, 3, 4, 5]) # Constrain y
agv_frame.add_support(n27.id, [1, 3, 4, 5]) # Constrain y
agv_frame.add_support(n50.id, [0, 1, 2, 3, 4, 5]) # Constrain xyz
agv_frame.add_support(n54.id, [0, 1, 2, 3, 4, 5]) # Constrain xyz

# Apply loadcases
agv_frame.add_load(n1.id, [0, -500, 0, 0, 0, 0]) # Front Left Wheel
agv_frame.add_load(n6.id, [0, -500, 0, 0, 0, 0]) # Front Left Wheel

agv_frame.add_load(n39.id, [0, 500, 0, 0, 0, 0]) # Front Right Wheel
agv_frame.add_load(n43.id, [0, 500, 0, 0, 0, 0]) # Front Right Wheel
...
# Write result files
export_nodal_displacements(agv_frame, U, "nodal_displacement_torsionalTest.dat")
calculate_stress(agv_frame, U, "stresses_output_torsionalTest.dat")

# Visualise results
visualize_structure(agv_frame, U, scale = 20, name = "torsionalTest")

plot_stress_distribution(agv_frame, U, stress_component = "sigma_axial", filename = "stress_torsionalTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_bending_y", filename = "stress_torsionalTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_bending_z", filename = "stress_torsionalTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "tau_torsion", filename = "stress_torsionalTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_total", filename = "stress_torsionalTest.png")