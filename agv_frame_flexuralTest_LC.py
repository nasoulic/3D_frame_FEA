...
# Apply loadcases
agv_frame.add_load(n1.id, [0, 1000, 0, 0, 0, 0]) # Front Left Wheel
agv_frame.add_load(n6.id, [0, 1000, 0, 0, 0, 0]) # Front Left Wheel

agv_frame.add_load(n39.id, [0, 1000, 0, 0, 0, 0]) # Front Right Wheel
agv_frame.add_load(n43.id, [0, 1000, 0, 0, 0, 0]) # Front Right Wheel
...
# Write result files
export_nodal_displacements(agv_frame, U, "nodal_displacement_flexuralTest.dat")
calculate_stress(agv_frame, U, "stresses_output_flexuralTest.dat")

# Visualise results
visualize_structure(agv_frame, U, scale = 2, name = "flexuralTest")

plot_stress_distribution(agv_frame, U, stress_component = "sigma_axial", filename = "stress_flexuralTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_bending_y", filename = "stress_flexuralTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_bending_z", filename = "stress_flexuralTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "tau_torsion", filename = "stress_flexuralTest.png")
plot_stress_distribution(agv_frame, U, stress_component = "sigma_total", filename = "stress_flexuralTest.png")